...
export const CAMPAIGN_TRANSITIONS: Record<CampaignStatus, readonly CampaignStatus[]> = {
  ...
  QUEUED_NO_CHANNEL: [CAMPAIGN_STATUS.PROCESSING, CAMPAIGN_STATUS.ARCHIVED],
  BATCHED: [CAMPAIGN_STATUS.PROCESSING, CAMPAIGN_STATUS.LAUNCHING, CAMPAIGN_STATUS.ARCHIVED],
  LAUNCHING: [
